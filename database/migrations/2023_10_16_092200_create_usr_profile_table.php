    ...
    public function up()
    {
        Schema::create('usr_profile',
            function (Blueprint $table) {
                ...
                $table->date('date_of_insurance_entry')->nullable()->comment('勞健保加入日');
                $table->date('date_of_insurance_leave')->nullable()->comment('勞健保退出日');
                $table->integer('labor_insurance')->default(0)->comment('勞保金額');
                $table->integer('labor_insurance_oop')->default(0)->comment('勞保自付額');
                $table->integer('health_insurance')->default(0)->comment('健保金額');
                $table->integer('health_insurance_oop')->default(0)->comment('健保自付額');
