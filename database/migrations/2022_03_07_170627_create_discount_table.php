...
class CreateDiscountTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dis_discounts', function (Blueprint $table) {
            ...
            $table->string('status_code')->nullable()->comment('狀態碼');
            $table->string('status_title')->nullable()->comment('狀態名稱');
            $table->string('category_code')->nullable()->comment('類別code');
            $table->string('category_title')->nullable()->comment('類別名稱:全館,優惠券');
            $table->string('discount_type_code')->nullable()->comment('優惠方式');
            $table->string('discount_type_title')->nullable()->comment('優惠方式標題');
