                        ...
                        <div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-4">
                                    ...
                                    <select name="select2[]" id="select2-multiple" multiple="multiple" class="w-100 -select2 -multiple" data-placeholder="可多選">
                                        <option value="1">item 1</option>
                                        <option value="2">item 2</option>
                                        <option value="3">item 3</option>
                                    </select>
                                ...
                                <div class="col-4">
                                    ...
                                    <select name="select2[]" id="select2" class="w-100 -select2 -single" data-placeholder="請單選">
                                        <option value="1">item 1</option>
                                        <option value="2">item 2</option>
                                        <option value="3">item 3</option>
                                    </select>
