                    ...
                    @foreach ($dataList as $key => $data)
                        <tr>
                            ...
                            <td class="text-center">
                                @can('cms.depot.edit')
                                    <a href="{{ Route('cms.depot.product-index', ['id' => $data->id], true) }}"
                                        data-bs-toggle="tooltip" title="寄倉選品"
                            ...
                            <td class="text-center">
                                @can('cms.depot.edit')
                                    <a href="{{ Route('cms.depot.edit', ['id' => $data->id], true) }}" data-bs-toggle="tooltip"
                            ...
                            <td class="text-center">
                                @can('cms.depot.delete')
                                    <a href="javascript:void(0)"
                                        data-href="{{ Route('cms.depot.delete', ['id' => $data->id], true) }}"
