...
@section('sub-content')
    ...
    <div class="card">
        ...
        <form class="card-body" method="post" action="{{ $formAction }}">
            ...
            <x-b-form-group name="use_coupon" title="購物金" required="true">
            ...
            <x-b-form-group name="dividend_limit" title="購物金可抵扣上限(%)" required="true">
            ...
            <x-b-form-group name="dividend_rate" title="購物金回饋比例(%)" required="true">
            ...
            <x-b-form-group name="event_dividend_rate" title="活動購物金回饋比例(%)" required="true">
