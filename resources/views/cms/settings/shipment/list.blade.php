            ...
            <div class="row">
                        ...
                        @foreach ($shi_method as $method)
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input class="form-check-input" name="shi_method" type="radio"
                                        value="{{ $method->id }}">
                                    {{ $method->method }}
                                </label>
                            </div>
                ...
                <fieldset class="col-12 col-sm-6 mb-3">
                    ...
                    <div class="px-1 pt-1">
                        @foreach ($shi_temps as $temps)
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input class="form-check-input" name="shi_temps" type="radio"
                                        value="{{ $temps->id }}">
                                    {{ $temps->temps }}
                                </label>
                            </div>
                ...
                <fieldset class="col-12 col-sm-6 mb-3">
                    ...
                    <div class="px-1 pt-1">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" name="has_supplier" type="radio" value="1">
                                是
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" name="has_supplier" type="radio" value="0">
                                否
                            </label>
                        </div>
                    </div>
                            ...
                            <td class="text-center">
                                @can('cms.shipment.delete')
                                    <a href="javascript:void(0)"
                                        data-href="{{ Route('cms.shipment.delete', ['groupId' => $uData->group_id_fk], true) }}"
