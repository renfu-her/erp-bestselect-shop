...
@section('sub-content')
    ...
    <nav class="col-12 border border-bottom-0 rounded-top nav-bg">
        <div class="p-1 pb-0">
            ...
            <a href="{{ Route('cms.credit_manager.ask') }}" class="btn btn-sm btn-primary mb-1" role="button">整批請款</a>
            <a href="{{ Route('cms.credit_manager.claim') }}" class="btn btn-sm btn-primary mb-1" role="button">整批入款</a>
            <a href="{{ Route('cms.credit_percent.index') }}" class="btn btn-sm btn-success mb-1" role="button">請款比例列表</a>
            @endcan
            <a href="{{ Route('cms.credit_bank.index') }}" class="btn btn-sm btn-success mb-1" role="button">銀行列表</a>
            <a href="{{ Route('cms.credit_card.index') }}" class="btn btn-sm btn-success mb-1" role="button">信用卡列表</a>
        </div>
    </nav>
