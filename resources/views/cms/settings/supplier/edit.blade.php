                    ...
                    <div class="px-1 pt-1">
                        <div class="form-check mb-3">
                            <label class="form-check-label" data-type="現金">
                                <input class="form-check-input" name="type" value="0" type="checkbox" required>
                            </label>
                        </div>
                        <div class="form-check mb-3">
                            <label class="form-check-label" data-type="外幣">
                                <input class="form-check-input" name="type" value="3" type="checkbox" required>
                            </label>
                        </div>
                        <div class="form-check mb-3">
                            <label class="form-check-label" data-type="匯款">
                                <input class="form-check-input" name="type" value="2" type="checkbox" required>
                            </label>
                            <div class="row">
                        ...
                        <div class="form-check mb-3">
                            <label class="form-check-label" data-type="支票">
                                <input class="form-check-input" name="type" value="1" type="checkbox" required>
                            </label>
                            <div class="row">
                        ...
                        <div class="form-check mb-3">
                            <label class="form-check-label" data-type="其他">
                                <input class="form-check-input" name="type" value="5" type="checkbox" required>
                            </label>
                        </div>
                    </div>
                </fieldset>
                <fieldset class="col-12 mb-3">
                    ...
                    <div class="px-1 pt-1">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label" data-type="現金">
                                <input class="form-check-input" name="default_type" value="0" type="radio" required>
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label" data-type="外幣">
                                <input class="form-check-input" name="default_type" value="3" type="radio" required>
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label" data-type="匯款">
                                <input class="form-check-input" name="default_type" value="2" type="radio" required>
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label" data-type="支票">
                                <input class="form-check-input" name="default_type" value="1" type="radio" required>
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label" data-type="其他">
                                <input class="form-check-input" name="default_type" value="5" type="radio" required>
                            </label>
                        </div>
                    </div>
                </fieldset>
