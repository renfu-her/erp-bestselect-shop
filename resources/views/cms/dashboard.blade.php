...
@section('sub-content')
    ...
    <div class="d-flex flex-wrap">
        <div class="col-12 col-xl-9">
            {{-- 電商訂單 --}}
            <h6 class="px-2"><i class="bi bi-cart-fill me-2"></i>電商訂單（已入帳）</h6>
                ...
                <div class="col px-3 py-2 d-flex align-items-end">
                    <div>
                        NT$ <span class="data text-nowrap">
                            @if (isset($reportDaily->price))
                                {{ number_format($reportDaily->price) }}
                            @else
                                0
                            @endif
                        </span> /
                        <span class="text-nowrap">
                            @if (isset($reportDaily->qty))
                                {{ $reportDaily->qty }}
                            @else
                                0
                            @endif 筆訂單
        ...
        <div class="col ms-0 ms-xl-3">
            ...
            <div class="bg-body">
                ...
                <table class="table table-striped table-bordered table-sm mb-0">
                    ...
                    <caption class="text-end border-top-0">更新時間：{{ date('Y/m/d H:i:s', strtotime($reportUpdatedTime)) }}
                    </caption>
                </table>
            </div>
        </div>
