                ...
                <table class="table table-sm table-hover tableList mb-1">
                    ...
                    <tbody>
                        @foreach($target_items as $t_value)
                            <tr>
                                <td class="text-wrap">
                                    <div class="fw-bold">{{ $t_value->ro_sn }}</div>
                                    <div class="text-nowrap">{{ $t_value->po_sn }}</div>
                                </td>
                                <td class="text-wrap">{{ $t_value->refund_grade_code }} {{ $t_value->refund_grade_name }}</td>
                                <td class="text-wrap">{{ $t_value->refund_title }}</td>
