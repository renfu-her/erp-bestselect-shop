            ...
            <div class="table-responsive tableOverBox border-bottom border-dark">
                <table class="table table-sm table-hover tableList mb-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-wrap">
                                <div class="fw-bold">{{ $value->append_po_sn }}</div>
                                <div class="text-nowrap">{{ $value->po_sn }}</div>
                            </td>
                            <td class="text-wrap">{{ $value->po_payable_grade_code }} {{ $value->po_payable_grade_name }}</td>
                            <td class="text-wrap">{{ $value->summary }}</td>
