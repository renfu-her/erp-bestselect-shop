...
@section('sub-content')
    ...
    <div class="pt-2 mb-3">
        <a href="{{ Route('cms.order.pay-order', ['id' => $sub_order->order_id, 'sid' => $sub_order->id]) }}" class="btn btn-primary" role="button">
        ...
        <div class="row justify-content-end mb-4">
            ...
            <div class="card shadow p-4 mb-4">
                <div class="card-body">
                    <div class="col">
                        <dl class="row mb-0">
                            <dt>支付對象：{{ $supplier ? $supplier->name . ' - ' . $supplier->contact_person : '' }}</dt>
                        </dl>
                    </div>
                </div>
