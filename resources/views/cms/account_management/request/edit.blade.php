...
@section('sub-content')
    ...
    <form method="POST" action="{{ $form_action }}">
        ...
        <div class="card shadow p-4 mb-4">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 mb-3">
                    ...
                    <select class="form-select -select2 -single @error('request_grade_id') is-invalid @enderror" name="request_grade_id" data-placeholder="請選擇會計科目" required>
                        <option value="" selected disabled>請選擇</option>
                        @foreach($total_grades as $g_value)
                            <option value="{{ $g_value['primary_id'] }}"{{ $g_value['primary_id'] == old('request_grade_id') ? 'selected' : '' }}
        ...
        <div class="col-auto">
            ...
            <a href="{{ Route('cms.request.index') }}" class="btn btn-outline-primary px-4" role="button">取消</a>
        </div>
    </form>
@endsection
