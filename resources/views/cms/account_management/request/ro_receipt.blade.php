    ...
    <nav class="col-12 border border-bottom-0 rounded-top nav-bg">
        <div class="p-1 pb-0">
            @can('cms.collection_received.edit')
                <a href="{{ route('cms.collection_received.edit', ['id' => $received_order->id]) }}" class="btn btn-sm btn-success px-3 mb-1" role="button">修改</a>
            ...
            @can('cms.collection_received.edit')
            <a href="{{ route('cms.ref_expenditure_petition.edit', ['current_sn' => $received_order->sn]) }}" class="btn btn-sm btn-primary mb-1" role="button">相關單號</a>
            @endcan
