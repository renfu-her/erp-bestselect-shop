        ...
        <div class="card shadow p-4 mb-4">
            ...
            <div class="row">
                <div class="col-11">
                    ...
                    <input type="date" name="cashing_date" class="form-control @error('cashing_date') is-invalid @enderror" placeholder="請輸入次交日期" aria-label="次交日期" value="{{ old('cashing_date', date('Y-m-d', strtotime( date('Y-m-d'))) ) }}" required>
                    @endif
