...
@section('sub-content')
    ...
    <div class="pt-2 mb-3">
        <a href="{{ Route('cms.ar_csnorder.receipt', ['id' => $received_order->source_id]) }}" class="btn btn-primary" role="button">
                    ...
                    <tbody>
                        ...
                        @foreach($order_list_data as $value)
                            <tr>
                                ...
                                <td>
                                    @if($product_grade_f)
                                        <select class="form-select -select2 -single" name="product_grade_id" data-placeholder="請選擇會計科目" required>
                                            <option value="" selected disabled>請選擇</option>
                                            @foreach($total_grades as $g_value)
                                ...
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="product[{{ $value->product_id }}][taxation]" value="1" type="radio" id="tax_{{ $serial }}_1" required @if ($value->product_taxation == '1') checked @endif>
                                        <label class="form-check-label" for="tax_{{ $serial }}_1">應稅</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="product[{{ $value->product_id }}][taxation]" value="0" type="radio" id="tax_{{ $serial }}_2" required @if ($value->product_taxation == '0') checked @endif>
                                        <label class="form-check-label" for="tax_{{ $serial }}_2">免稅</label>
                                    </div>
                                </td>
                                <td>
                        ...
                        @if($order->dlv_fee > 0)
                            <tr>
                                <td class="text-center">{{ $serial }}</td>
                                <td>
                                    <select class="form-select -select2 -single" name="logistics_grade_id" data-placeholder="請選擇會計科目" required>
                                        <option value="" selected disabled>請選擇</option>
                                        @foreach($total_grades as $g_value)
                                ...
                                <td>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="order_dlv[{{ $order->id }}][taxation]" value="1" type="radio" id="tax_{{ $serial }}_1" required @if ($order->dlv_taxation == '1') checked @endif>
                                        <label class="form-check-label" for="tax_{{ $serial }}_1">應稅</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="order_dlv[{{ $order->id }}][taxation]" value="0" type="radio" id="tax_{{ $serial }}_2" required @if ($order->dlv_taxation == '0') checked @endif>
                                        <label class="form-check-label" for="tax_{{ $serial }}_2">免稅</label>
                                    </div>
                                </td>
                                <td></td>
                        ...
                        @if($order->discount_value > 0)
                            @foreach($order_discount ?? [] as $d_value)
                                <tr>
                                    <td class="text-center">{{ $serial }}</td>
                                    <td>
                                        <select class="form-select -select2 -single" name="discount[{{ $d_value->id }}][grade_id]" data-placeholder="請選擇會計科目" required>
                                            <option value="" selected disabled>請選擇</option>
                                            @foreach($total_grades as $g_value)
                                    ...
                                    <td>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="discount[{{ $d_value->id }}][taxation]" value="1" type="radio" id="tax_{{ $serial }}_1" required @if ($d_value->discount_taxation == '1') checked @endif>
                                            <label class="form-check-label" for="tax_{{ $serial }}_1">應稅</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="discount[{{ $d_value->id }}][taxation]" value="0" type="radio" id="tax_{{ $serial }}_2" required @if ($d_value->discount_taxation == '0') checked @endif>
                                            <label class="form-check-label" for="tax_{{ $serial }}_2">免稅</label>
                                        </div>
                                    </td>
                                    <td></td>
