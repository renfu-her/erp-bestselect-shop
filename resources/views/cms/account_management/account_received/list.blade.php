                    ...
                    @foreach ($data_list as $key => $data)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('cms.account_received.ro-edit', ['id' => $data->append_ro_source_id]) }}" class="-text">{{ $data->append_ro_sn }}</a>
                                @elseif($data->append_ro_source_type == 'ord_received_orders' && $data->account_status_code == 1)
                                <a href="{{ route('cms.account_received.ro-receipt', ['id' => $data->append_ro_source_id]) }}" class="-text">{{ $data->append_ro_sn }}</a>
                                @endif
                            </td>
                            <td>
