        ...
        <div class="card shadow p-4 mb-4">
            ...
            <div class="row mx-0 align-items-center oneItem -cloneElem d-none">
                <div class="form-control d-flex align-items-center col me-2 py-1">
                    <span class="icon -upLv icon-btn col-auto fs-3 text-primary p-0 rounded" data-bs-toggle="tooltip"
                        title="上階">
                        <i class="bi bi-arrow-left-short"></i>
                    </span>
                    <span class="icon -downLv icon-btn col-auto fs-3 text-primary p-0 rounded" data-bs-toggle="tooltip"
                        title="下階">
