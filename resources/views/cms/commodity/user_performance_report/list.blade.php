            ...
            <table class="table table-striped tableList">
                ...
                <tbody>
                    ...
                    <tr>
                        <td></td>
                        <td>合計</td>
                        <td class="text-center">{{ $on_price }}</td>
                        <td class="text-center">{{ $on_gross_profit }}</td>
                        <td class="text-center">{{ $off_price }}</td>
                        <td class="text-center">{{ $off_gross_profit }}</td>
                        <td class="text-center">{{ $total_gross_profit }}</td>
...
@once
    ...
    @push('sub-scripts')
        <script>
            // 阿眉～
            let selectedUser = @json($cond['department']);
