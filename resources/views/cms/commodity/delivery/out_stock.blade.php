...
@section('sub-content')
    <h2 class="mb-3">#{{ $breadcrumb_data['sn'] }} 缺貨審核</h2>
    ...
    <form id="form1" method="post" action="{{ $formAction }}">
        ...
        <div class="card shadow p-4 mb-4">
            <h6>缺貨單內容</h6>
            <div class="col-12">
                <label class="form-label">缺貨單備註</label>
                <input class="form-control" type="text" value="{{$delivery->out_memo ?? ''}}" name="dlv_memo" placeholder="缺貨單備註">
            </div>
