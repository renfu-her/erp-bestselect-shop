        ...
        @foreach ($subOrders as $subOrder)
            ...
            <div @class(['card shadow mb-4 -detail',
                ...
                <div class="card-header px-4 py-3 d-flex align-items-center bg-white flex-wrap justify-content-end">
                    ...
                    <div class="d-flex">
                        <a class="btn btn-success -in-header" href="{{ Route('cms.logistic.change-logistic-status', ['event' => \App\Enums\Delivery\Event::order()->value, 'subOrderId' => $subOrder->id], true) }}">配送狀態</a>
