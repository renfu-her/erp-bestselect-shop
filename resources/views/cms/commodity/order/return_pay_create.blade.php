...
@section('sub-content')
    ...
    <form method="POST" action="{{ $form_action }}">
        ...
        <div class="card shadow p-4 mb-4">
            ...
            <p class="fw-bold">支付對象：{{ $buyer ? $buyer->name : '' }}</p>
                        ...
                        @foreach($sub_order as $so_value)
                            ...
                            <tr>
                                <td class="text-wrap">
                                    ...
                                    <div class="text-nowrap">{{ $so_value->sn }}</div>
                                </td>
                                <td class="text-wrap">{{ $product_grade_name }}</td>
                                <td class="text-wrap">{{ $p_value->product_title }}{{'（' . $so_value->ship_event . ' - ' . $so_value->ship_category_name . '）'}}{{'（' . $p_value->price . ' * ' . $p_value->qty . '）'}}</td>
        ...
        <div class="card shadow p-4 mb-4">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 mb-3 cheque">
                    ...
                    <select name="cheque[status_code]" class="form-select @error('cheque[status_code]') is-invalid @enderror" aria-label="Select" required data-placeholder="請選擇狀態">
        ...
        <div class="col-auto">
            ...
            <a href="{{ Route('cms.order.return-pay-order', ['id' => $paying_order->source_id, 'sid' => $paying_order->source_sub_id]) }}" 
