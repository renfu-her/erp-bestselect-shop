                ...
                <table class="table table-bordered align-middle">
                    <tbody class="border-top-0">
                        ...
                        <tr>
                            ...
                            <td style="width:35%"><input type="email" name="buyer_email" class="form-control @error('buyer_email') is-invalid @enderror" placeholder="請輸入買受人E-mail" aria-label="買受人E-mail" value="{{ old('buyer_email', $invoice->buyer_email) }}"></td>
                                ...
                                @foreach(old('o_title') as $key => $value)
                                    <tr class="-cloneElem">
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm flex-nowrap">
                                                <span class="input-group-text"><i class="bi bi-currency-dollar"></i></span>
                                                <input type="number" name="o_price[]" class="form-control form-control-sm -sm" value="{{ old('o_price.' . $key) }}" aria-label="價格(單價)" min="0" required>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm flex-nowrap">
                                                <span class="input-group-text"><i class="bi bi-currency-dollar"></i></span>
                                                <input type="number" name="o_total_price[]" class="form-control form-control-sm -sm" value="{{ old('o_total_price.' . $key) }}" aria-label="價格(總價)" min="0" required>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group input-group-sm flex-nowrap">
                                                <span class="input-group-text"><i class="bi bi-currency-dollar"></i></span>
                                                <input type="number" name="o_tax_price[]" class="form-control form-control-sm -sm" value="{{ old('o_tax_price.' . $key) }}" aria-label="稅額" min="0" required>
                                            </div>
                                        </td>
                                        <td>
                                            <select name="o_taxation[]" class="form-select form-select-sm" required>
