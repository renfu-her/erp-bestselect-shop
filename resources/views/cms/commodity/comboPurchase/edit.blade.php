...
<form action="">
        ...
        <div class="row justify-content-center mb-3">
            ...
            <div class="col-auto mb-3">
                <div class="input-group input-group-lg has-validation">
                    ...
                    <input type="number" class="form-control text-center" name="qty" value="0" min="-{{ $style->in_stock }}">
    ...
    <div>
        <div class="col-auto">
            ...
            <a href="{{ Route('cms.combo-purchase.index') }}" class="btn btn-outline-primary px-4" role="button">返回列表</a>
        </div>
    </div>
</form>
            ...
            function countStock() {
                ...
                $('tbody td[data-td="qty"]').each(function (index, element) {
                    ...
                    if (isFinite(m_qty) && isFinite(qty) && isFinite(stock)) {
                        ...
                        if (remainder < 0) {
                            $(element).siblings('td[data-td="count"]').removeClass('text-primary').addClass('text-danger');
                            $('form button[type="submit"]').prop('disabled', true);
                        } else {
                            $(element).siblings('td[data-td="count"]').removeClass('text-danger').addClass('text-primary');
