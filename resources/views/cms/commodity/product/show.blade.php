    ...
    <div class="accordion accordion-flush open">
        ...
        <div class="accordion-item">
            <h3 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-target="#collapse1" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapse1">
                    商品圖片
                </button>
            </h3>
        ...
        <div class="accordion-item">
            <h3 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-target="#collapse2" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapse2">
                    銷售通路
                </button>
            </h3>
                        ...
                        <tbody>
                            @foreach ($styles as $style)
                                @foreach ($style->prices as $i => $price)
                                    <tr>
                                        @if ($i === 0)
                                            <th rowspan="{{ count($style->prices) }}" class="text-center table-warning">{{ $style->title }}</th>
                                        @endif
        ...
        <div class="accordion-item">
            <h3 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-target="#collapse3" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapse3">
                    商品介紹
                </button>
            </h3>
        ...
        <div class="accordion-item">
            <h3 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-target="#collapse4" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapse4">
                    規格說明
                </button>
            </h3>
        ...
        <div class="accordion-item">
            <h3 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-target="#collapse5" data-bs-toggle="collapse" aria-expanded="true" aria-controls="collapse5">
                    運送方式
                </button>
            </h3>
        ...
        function copyToClipboard(link) {
            if (navigator.clipboard) {
                ...
                .then(() => {
                    ...
                    toast.show(`不支援剪貼簿功能，請手動複製網頁連結：<br>${link}`, { type: 'danger' });
                });
            }
        }
       </script>
