            ...
            <table class="table tableList table-striped">
                ...
                <tbody class="-appendClone">
                    <tr class="-cloneElem">
                        ...
                        <td>
                            <input type="text" class="form-control form-control-sm -l"
                                value="P211105001-42" aria-label="訂單編號" readonly />
                        </td>
                        <td>
                        ...
                        <td class="text-center">
                            <button type="button" disabled class="icon -del icon-btn fs-5 text-danger rounded-circle border-0 p-0">
                    ...
                    <tr class="-cloneElem">
                        ...
                        <td>
                            <input type="text" class="form-control form-control-sm -l"
                                value="" aria-label="訂單編號" readonly />
                        </td>
                        <td>
                            <select name="" class="form-select form-select-sm">
                                <option value="S">S</option>
