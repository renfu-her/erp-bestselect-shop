    ...
    <form method="POST" action="{{ $formAction }}">
        ...
        <div class="card shadow p-4 mb-4">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 mb-3 cheque">
                    <label class="form-label cheque">到期日 <span class="text-danger">*</span></label>
                ...
                <div class="col-12 col-sm-6 mb-3 cheque">
                    <label class="form-label cheque">兌現日 <span class="text-danger">*</span></label>
                ...
                <div class="col-12 col-sm-6 mb-3 remit">
                    <label class="form-label remit">匯款日期 <span class="text-danger">*</span></label>
                ...
                <div class="col-12 col-sm-6 mb-3 foreign_currency">
                    <label class="form-label foreign_currency">幣別 <span class="text-danger">*</span></label>
                    <select name="foreign_currency[currency]" class="form-select -select2 -single foreign_currency 
                        @error('foreign_currency[currency]') is-invalid @enderror" required data-placeholder="請選擇幣別">
                        <option value="" selected disabled>請選擇</option>
                ...
                <div class="col-12 col-sm-6 mb-3 foreign_currency">
                    <label class="form-label foreign_currency">匯率 <span class="text-danger">*</span></label>
                ...
                <div class="col-12 col-sm-6 mb-3 foreign_currency">
                    <label class="form-label foreign_currency">金額（外幣） <span class="text-danger">*</span></label>
        ...
        <div class="col-auto">
            ...
            <a href="{{ Route('cms.purchase.view-pay-order', ['id' => request('purchaseId'), 'type' => request('isFinalPay')], true) }}" 
