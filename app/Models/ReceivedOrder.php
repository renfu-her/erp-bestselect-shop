        ...
        switch ($request['received_method']) {
            ...
            case ReceivedMethod::CreditCard:
                ...
                DB::table('acc_received_credit')->where('id', $request['received_method_id'])->update([
                    ...
                    'card_type_code'=>array_key_exists($request['card_type_code'], $checkout_area) ? $request['card_type_code'] : null,
                    'card_type'=>array_key_exists($request['card_type_code'], $checkout_area) ? $card_type[$request['card_type_code']] : null,
