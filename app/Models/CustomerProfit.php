...
class CustomerProfit extends Model
{
    ...
    public static function createProfit($customer_id, $bank_id, $bank_account, $bank_account_name, $identity_sn, $img1 = null, $img2 = null, $img3 = null, $recommender_sn = null)
    {
        ...
        if ($recommender_sn) {
            $customer = Customer::where('sn', $recommender_sn)->get()->first();
            if ($customer) {
                Customer::where('id', $customer_id)->update([
                    'recommend_id' => $customer->id,
                ]);
            }
        }
