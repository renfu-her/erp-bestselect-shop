...
class Product extends Model
{
    ...
    public static function productStyleList($keyword = null, $type = null, $stock_status = [], $options = [])
    {
        $re = DB::table('prd_products as p')
            ...
            ->select('s.id', 's.sku', 's.estimated_cost', 'p.title as product_title', 'p.id as product_id', 's.title as spec', 's.safety_stock', 's.total_inbound', 's.in_stock as current_stock')
