...
//            , $audit_date, $audit_user_id, $audit_user_name, $audit_status
            ...
            $rePcsLSC = PurchaseLog::stockChange($id, null, Event::consignment()->value, $id, LogEventFeature::csn_add()->value, null,null, null, $create_user_id, $create_user_name);
...
//        $purchase->scheduled_date = $purchaseReq['scheduled_date'] ?? null;
        ...
        return DB::transaction(function () use ($purchase, $id, $purchaseReq, $operator_user_id, $operator_user_name, $orign_audit_status
            ...
            if ($purchase->isDirty()) {
                foreach ($purchase->getDirty() as $key => $val) {
                    ...
                    $rePcsLSC = PurchaseLog::stockChange($id, null, Event::consignment()->value, $id, LogEventFeature::csn_change_data()->value, null,null, $event, $operator_user_id, $operator_user_name);
                    if ($rePcsLSC['success'] == 0) {
                        DB::rollBack();
                        return $rePcsLSC;
                    }
    ...
    public static function del($id, $operator_user_id, $operator_user_name) {
        ...
        if (null != $consignment->audit_date) {
            ...
            return DB::transaction(function () use ($id, $operator_user_id, $operator_user_name
                ...
                $rePcsLSC = PurchaseLog::stockChange($id, null, Event::consignment()->value, $id, LogEventFeature::csn_del()->value, null,null, null, $operator_user_id, $operator_user_name);
                if ($rePcsLSC['success'] == 0) {
                    DB::rollBack();
                    return $rePcsLSC;
                }
    ...
    public static function close($id, $operator_user_id, $operator_user_name) {
        ...
        PurchaseLog::stockChange($id, null, Event::consignment()->value, $id, LogEventFeature::csn_close()->value, null,null, null, $operator_user_id, $operator_user_name);
    }
