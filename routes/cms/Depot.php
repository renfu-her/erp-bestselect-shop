...
Route::group(['prefix' => 'depot','as'=>'depot.'], function () {
    ...
    Route::get('product/{id}', [DepotCtrl::class, 'product_index'])->name('product-index')->middleware('permission:cms.depot.product-index');
    Route::match(['get', 'post'], 'product/{id}/create', [DepotCtrl::class, 'product_create'])->name('product-create')->middleware('permission:cms.depot.product-create');
    Route::match(['get', 'post'], 'product/{id}/edit', [DepotCtrl::class, 'product_edit'])->name('product-edit')->middleware('permission:cms.depot.product-edit');
    Route::get('product/{id}/delete', [DepotCtrl::class, 'product_delete'])->name('product-delete')->middleware('permission:cms.depot.product-delete');
});
