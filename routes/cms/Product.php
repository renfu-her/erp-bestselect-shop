...
Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
    ...
    Route::post('edit/{id}/sale/{sid}/stock', [ProductCtrl::class, 'updateStock']); //->middleware('permission:cms.product.sale');

    Route::get('edit/{id}/sale/{sid}/price', [ProductCtrl::class, 'editPrice'])->name('edit-price'); //->middleware('permission:cms.product.sale');
    Route::post('edit/{id}/sale/{sid}/price', [ProductCtrl::class, 'updatePrice']); //->middleware('permission:cms.product.sale');
