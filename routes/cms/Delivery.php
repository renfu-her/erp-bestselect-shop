...
Route::group(['prefix' => 'delivery','as'=>'delivery.'], function () {
    ...
    Route::get('delete/{receiveDepotId}/{event}/{eventId}', [LogisticCtrl::class, 'destroyItem'])->name('delete')->middleware('permission:cms.delivery.delete');
    Route::get('delete/{subOrderId}/{receiveDepotId}', [DeliveryCtrl::class, 'destroy'])->name('delete')->middleware('permission:cms.delivery.delete');
});
