...
Route::group(['prefix' => 'delivery','as'=>'delivery.'], function () {
    ...
    Route::post('create/{subOrderId}', [DeliveryCtrl::class, 'store']);
    Route::get('delete/{subOrderId}', [DeliveryCtrl::class, 'destroy'])->name('delete')->middleware('permission:cms.delivery.delete');
});
