...
Route::group(['prefix' => 'delivery','as'=>'delivery.'], function () {
    ...
    Route::get('create/{orderId}', [DeliveryCtrl::class, 'create'])->name('create')->middleware('permission:cms.delivery.create');
    Route::post('create/{orderId}', [DeliveryCtrl::class, 'store']);
