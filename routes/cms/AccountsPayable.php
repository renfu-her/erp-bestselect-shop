...
Route::group(['prefix' => 'accounts_payable', 'as' => 'accounts_payable.'], function () {
    ...
    Route::match(['get', 'post'], 'claim/{type}/{id}/{key}', [AccountsPayableCtrl::class, 'claim'])->name('claim')->middleware('permission:cms.accounts_payable.edit')->where(['type' => '(g|t)']);
    ...
    Route::get('po_show/{id}', [AccountsPayableCtrl::class, 'po_show'])->name('po-show');
});
