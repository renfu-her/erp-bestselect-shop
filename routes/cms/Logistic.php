...
Route::group(['prefix' => 'logistic','as'=>'logistic.'], function () {
    ...
    Route::get('update-logistic-status/{event}/{eventId}/{deliveryId}', [LogisticCtrl::class, 'updateLogisticStatus'])->name('updateLogisticStatus')->middleware('permission:cms.logistic.create');
