...
// 新增優惠代碼
Breadcrumbs::for('cms.promo-code.create', function (BreadcrumbTrail $trail) {
    $trail->parent('cms.promo-code.index');
    $trail->push('新增優惠代碼');
});
// 編輯 優惠代碼
Breadcrumbs::for('cms.promo-code.edit', function (BreadcrumbTrail $trail, $value) {
    $trail->parent('cms.promo-code.index');
    $trail->push('[' . $value . '] 編輯');
});
